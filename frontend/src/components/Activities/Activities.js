...
function Activities() {
  ...
  const backBtn = (
    ...
    >
      ...
      />
      <path
        d="M10.3117 18.4863L4.12451 12.4863L10.3117 6.48633"
        stroke="#333333"
        strokeWidth="1.22693"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  const pushPin = (
    ...
    >
      <g clipPath="url(#clip0)">
        <path
          d="M9.89933 14.2667L9.89913 14.2669C9.79794 14.365 9.6258 14.365 9.52461 14.2669L3.867 8.78044C3.77683 8.69296 3.77697 8.56 3.8669 8.47278L3.86711 8.47259C3.91319 8.42786 3.98021 8.39909 4.05445 8.39909H6.9973H7.26071L7.44981 8.21571L12.8789 2.95084L13.3313 2.51217L16.017 5.11665L15.5934 5.5275L10.1642 10.7924L9.96673 10.9839V11.259V14.1128C9.96673 14.1669 9.94476 14.2227 9.89933 14.2667Z"
          stroke="#606060"
          strokeWidth="1.3"
        />
        <path
          d="M6.69569 12.4292L2.14577 16.8415C1.57037 17.3994 0.849454 17.7952 0.0600586 17.9866C0.257407 17.2211 0.665507 16.522 1.24091 15.964L5.79083 11.5518L6.69569 12.4292Z"
          fill="#606060"
        />
      </g>
      <defs>
        <clipPath id="clip0">
          <rect
            ...
            height="17"
            fill="white"
            transform="translate(0.0600586 0.986328)"
          />
        </clipPath>
      </defs>
    </svg>
  ...
  const trash = (
    ...
    >
      <path
        d="M2.375 5.23633H3.83587H15.5228"
        stroke="#606060"
        strokeWidth="2.23"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  const markAsRead = (
    ...
    >
      ...
      />
      <path
        d="M16.2056 11.1938L10.6579 16.5737L8.13623 14.1283"
        stroke="#606060"
        strokeWidth="1.25"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  return (
    <div className={classes.activities}>
      <div className={classes.header}>
        ...
        <div className={classes.allActivities}>All Activities</div>
        <div className={classes.pushPin}>{pushPin}</div>
