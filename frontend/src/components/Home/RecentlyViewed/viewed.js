...
function viewed({ image, name, dateViewed, altText, bgColor }) {
  return (
    <div className="tw-w-auto tw-flex tw-flex-col">
      <div className={`tw-w-32 tw-h-32 md:tw-w-28 md:tw-h-28  lg:tw-w-56 lg:tw-h-52 xl:tw-w-60 xl:tw-h-56 tw-flex tw-justify-around ${bgColor} tw-rounded-md tw-transition-all tw-duration-150 tw-shadow-md`}>
