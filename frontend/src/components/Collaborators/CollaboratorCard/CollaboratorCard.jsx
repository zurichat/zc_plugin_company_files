...
const CollaboratorCard = (props) => {
  ...
  const { users } = useSelector((state) => state.rootReducer.workspaceReducer);
  ...
  return (
    <div className="collab_permission">
      ...
      <div className="collab_nav tw-flex tw-justify-between">
        ...
        <div>
          <button type="button" className="invite_btn" value={text}>
            Send Invite
          </button>
        </div>
      </div>
      ...
      <div className="collab_footer tw-py-2 tw-px-2 tw-items-end tw-flex tw-justify-between">
        ...
        <div>
          ...
          >
            <AiOutlineCloseCircle className="tw-mr-2" /> Close
          </button>
        </div>
      </div>
      {/* <style jsx>
