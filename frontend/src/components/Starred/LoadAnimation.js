  ...
  return (
    <div className="tw-text-center tw-mt-60 tw-preloader">
      <div className="tw-p-3 tw-flex tw-items-center tw-text-center tw-justify-center">
       ...
       <svg class="tw-animate-bounce tw-h-4 tw-w-4 tw-mr-3 tw-bg-green-600 tw-rounded-full" viewBox="0 0 24 24">
        </svg>
       ...
       <svg class="tw-animate-bounce tw-h-1 tw-w-1 tw-mr-3 tw-bg-green-200 tw-rounded-full" viewBox="0 0 24 24">
        </svg>
             </div>
