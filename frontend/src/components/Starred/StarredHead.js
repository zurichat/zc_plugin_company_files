...
function StarredHead({ error,
    ...
    const handleEmptyStarred = () => {
      fetch("https://companyfiles.zuri.chat/api/v1/file/searchStarredFiles", {
        method: "POST",
    ...
    return (
        ...
        <div className="flex justify-between pt-4 pb-5">
          <h3 className="font-semibold text-xl itemsTrash">Starred</h3>
          <p>
            <span className="pr-2">
              <svg
                width="26"
        ...
        <div className="flex flex-col sm:flex-row justify-between light--Green">
          <p className="px-2 sm:px-5 py-4 durationGray text-sm">
            All Starred Files/Folders can be ocated here.
          </p>
          <p
