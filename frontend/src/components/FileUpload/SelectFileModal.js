...
const SelectFileModal = ({
  ...
  if (upload) {
    return (
      <div className="w-full h-screen absolute top-0 left-0 bg-black bg-opacity-75 overflow-y-hidden">
        <div
          ref={dragArea}
        ...
        >
          ...
          <div id="uploadBtn my-2">
            <label className=" flex justify-between bg-white text-gray-600 ">
              ...
              />
              <span className='hover:text-white min-w-max px-[14px] py-[8px] hover:bg-green-500 rounded-md text-center cursor-pointer'>Choose Files</span>
          ...
          {!files ? (
            ...
            <div
              className="w-auto max-h-[200px] relative  p-8 flex flex-col  border-2 my-2 border-dashed border-green-300 overflow-y-auto"
