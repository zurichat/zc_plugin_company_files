          ...
          >
            ...
            <div id="uploadBtn my-2">
              <label className=" flex justify-between bg-white text-gray-600 ">
                ...
                />
                <span className="hover:text-white border border-green-100 px-4 py-2 hover:bg-green-500 rounded-md text-center cursor-pointer">
                  Choose Files
                </span>
            ...
            {!files ? (
              <div
                ref={dragNdrop}
                className="relative dragNdrop my-2 border-2 border-dashed  w-full h-52 flex overflow-y-auto"
              >
                <div className="m-auto">
                  <img src={uploadImg} alt="" className="mx-auto w-1/3" />
                  <p className="text-gray-400 text-6">Drop Files Here</p>
                </div>
              </div>
            ) : (
            ...
            <div className="uploadActions flex justify-end border-t mt-6 pt-6 text-sm">
              <button
                onClick={uploadFiles}
                className="mx-4 px-3 py-2 bg-green-500 text-white rounded-sm"
              >
                Upload
              </button>
              <button
                onClick={clearFiles}
                className=" px-3 py-2  border border-green-100 text-green-500 text-sm"
              >
                Clear
              </button>
            </div>
