    ...
    <div ref={thisElement} style={{ width: "100%"}}>
      ...
      <div className="file-name justify-between px-3 my-2" key={file.name} style={{ boxSizing: "border-box", alignItems: "center", color: "grey" }} >
        <div className="w-full" style={{ display: "flex", alignItems: "center" }}>
          <div className="file-status-container w-full flex" style={{ alignItems: "center"}}>
            <span ref={thisElement} style={{ fontSize: ".9rem", backgroundColor: "purple"}} className="file-status mr-2 inline-block p-[3px] text-center rounded-full text-white">
              <FaRegHourglass style={{ fontSize: ".75rem"}} />
            </span>
            <p style={{ overflowX: "hidden" }} className="w-3/4 text-[14px] truncate">
              {file.name}
            </p>
          </div>
          <div className="file-actions w-2/12 text-right" style={{ marginLeft: "auto", fontSize: ".9rem", display: "flex", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center" }} >
          <div className="progress-bar-container w-full h-[6px] my-2 mr-2 bg-green-50 rounded-full">
            <div className="progress-bar w-[200px] block h-full bg-green-400 rounded-full" ></div>
          </div>
...
const UploadProgressModal = ({
  ...
  return (
    <div className="absolute bottom-12 right-12 z-30">
      {progress && (
        <div className="w-[420px] h-[380px] px-[24px] py-[24px] bg-white shadow-2xl rounded-2xl">
          <div className="w-full flex items-center justify-between mb-4">
            <div className="text-gray-500">
              <p>Your Uploads</p>
              <div className="flex justify-between text-gray-400 my-1 ">
                <span className="mr-3">40%</span>
                <span className="inline-block w-[24px] h-[24px] mx-1 text-center rounded-full bg-green-500 text-white">
                  &#x2713;
                </span>
                
                <span className=" mx-1">{totalUploadedFiles}</span>
                <span className="inline-block w-[24px] h-[24px] mx-1 text-center rounded-full bg-red-500 text-white">
