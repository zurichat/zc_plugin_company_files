...
const UploadProgressModal = ({
  ...
  return (
    <div className="absolute bottom-12 right-12 z-30">
      {progress && (
        <div className="w-[400px] h-[380px] py-[24px] px-[26px] bg-white shadow-2xl rounded-2xl">
              ...
              {Object.entries(files).map((file) => (
                ...
                >
                  <div className="w-10/12">
                    ...
                    <span className="inline-block w-[24px] h-[24px] text-center rounded-full bg-red-600 text-white">
                      &#10005;
                    </span>
                    <p className="text-[14px] truncate">{file[1].name}</p>
