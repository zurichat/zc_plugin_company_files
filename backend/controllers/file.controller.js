...
const { BadRequestError, NotFoundError, InternalServerError } = require('../utils/appError');
...
/**
 * @desc    Sends a request to initialise a file upload
 * @route   POST /api/v1/files/uploadRequest
 * @access  Private
 */
...
/**
 * @desc    Gets the current status of a file being uploaded
 * @route   GET /api/v1/files/uploadStatus
 * @access  Private
 */
...
/**
 * @desc    Saves a cropped version of an image
 * @route   PUT /api/v1/files/crop
 * @access  Private
 */
...
/**
 * @desc    Returns all non-deleted files
 * @route   GET /api/v1/files/all
 * @access  Private
 */
...
/**
 * @desc    Sort files by query string
 * @route   GET /api/v1/files/sort
 * @access  Private
 */
...
/**
 * @desc    Copies a file to the origin folder, or another
 * @route   null
 * @access  Private
 */
 ...
 * @route   GET /api/v1/files/type/:type
 * @access  Private
 */
...
/**
 * @desc    Gets the details of a file
 * @route   GET /api/v1/files/read/:fileId
 * @access  Private
 */
...
/**
 * @desc    Renames a file
 * @route   GET /api/v1/files/rename/:fileId
 * @access  Private
 */
 ...
 * @route   DELETE /api/v1/files/deleteFile/:id
 * @access  Private
 */
...
/**
 * @desc    Deletes multiple files permanently
 * @route   POST /api/v1/files/deleteMultipleFiles
 * @access  Private
 */
...
/**
 * @desc    Sends a file to trash
 * @route   PUT /api/v1/files/deleteToBin/:id
 * @access  Private
 */
...
/**
 * @desc    Restores a file
 * @route   PUT /api/v1/files/restoreFile/:id
 * @access  Private
 */
...
/**
 * @desc    Cuts or moves a file
 * @route   PUT /api/v1/files/cutOrMove/:fileId/:folderId
 * @access  Private
 */
...
/**
 * @desc    Returns all deleted files
 * @route   GET /api/v1/files/deletedFiles
 * @access  Private
 */
...
/**
 * @desc    Checks for a file with a specified md5 value
 * @route   POST /api/v1/files/isDuplicate
 * @access  Private
 */
...
/**
 * @desc    Stars a file
 * @route   PUT /api/v1/files/starFile/:id
 * @access  Private
 */
...
/**
 * @desc    Unstars a file
 * @route   PUT /api/v1/files/unStarFile/:id
 * @access  Private
 */
...
exports.lockFile = async (req, res) => {
	...
	if(file.memberId !== creatorId || !creatorId){
