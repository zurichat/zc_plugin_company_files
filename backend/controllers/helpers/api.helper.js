...
class ApiConnection {
  ...
  fetchAll = async () => {
    try {
      const response = await axios.get(
        `${apiReadUrl}/${this.data.plugin_id}/${this.data.collection_name}/${this.data.organization_id}`
      );
  ...
  fetchOne = async (id) => {
    try {
      const response = await axios.get(
        `${apiReadUrl}/${this.data.plugin_id}/${this.data.collection_name}/${this.data.organization_id}?object_id=${id}`
      );
